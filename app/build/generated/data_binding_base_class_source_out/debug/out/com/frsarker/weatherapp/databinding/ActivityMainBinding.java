...
package com.frsarker.weatherapp.databinding;
...
import com.frsarker.weatherapp.R;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull RelativeLayout rootView, @NonNull TextView about,
      @NonNull TextView address, @NonNull LinearLayout addressContainer, @NonNull TextView cityName,
      ...
      @NonNull TextView pressure, @NonNull Button searchButton, @NonNull EditText searchCity,
      @NonNull TextView status, @NonNull TextView sunrise, @NonNull TextView sunset,
      @NonNull TextView temp, @NonNull TextView tempMax, @NonNull TextView tempMin,
      @NonNull TextView textDescription, @NonNull TextView updatedAt, @NonNull TextView wind) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((RelativeLayout) rootView, about, address, addressContainer,
          cityName, detailsContainer, errorText, humidity, loader, mainContainer, overviewContainer,
          pressure, searchButton, searchCity, status, sunrise, sunset, temp, tempMax, tempMin,
          textDescription, updatedAt, wind);
    }
